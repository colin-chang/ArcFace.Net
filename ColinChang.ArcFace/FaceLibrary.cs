...
public partial class ArcFace
{
    ...
    {
        using var img = await image.ToImage();
        return await SearchFaceAsync(img, _options.MinSimilarity, predicate);
    }
    ...
    private async Task<OperationResult<Recognitions>> SearchFaceAsync(Image image, float minSimilarity,
        Predicate<Face> predicate = null)
    {
